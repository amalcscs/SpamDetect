...
def upload_files(request):
    if request.method == 'POST':
        ...
        # 'avg_acc_score':avg_acc_score,'Dtree':Dtree,'RF':RF,'NB':NB,'KNN':KNN,'MLP':MLP,'lr':lr,'n':n,'value':value})
...
def make_prediction(data):
    ...
    if y==0:
        result = 'There is no possibility for malicious attack'
    elif y==1:
        result = 'There is a possibility of distributed denial of service attack'
    elif y==2:
        result = 'There is a possibility of denial of service attack'
    elif y==3:
        result = 'There is a possibility of ransomeware attack'
    print(result)
    return result
